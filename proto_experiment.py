...
def plot_trajectory(longitude, latitude, measurement, world):
    ...
    measurement_norm = measurement[:,2]
    ...
    cable_north = [world.target_array[0].start_point[0,0], world.target_array[0].end_point[0,0]]
    cable_east = [world.target_array[0].start_point[0,1], world.target_array[0].end_point[0,1]]
    
    # Plot cable with East on x-axis, North on y-axis
    plt.plot(cable_east, cable_north, 'r-', linewidth=2, label='Cable')
